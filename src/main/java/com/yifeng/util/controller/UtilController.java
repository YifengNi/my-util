...
public class UtilController {
    ...
    @ApiOperation("字符串转换")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "camelToUnderscore", value = "驼峰转大写下划线", required = true, dataType = "String"
                    , paramType = "query", defaultValue = "testWord"),
            @ApiImplicitParam(name = "underscoreToCamel", value = "大写下划线转驼峰", required = true, dataType = "String"
                    , paramType = "query", defaultValue = "TEST_WORD"),
    })
    public Map<String, Object> queryCarConfigSeries(@RequestParam String camelToUnderscore
